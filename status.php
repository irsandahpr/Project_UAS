...
?>
<html>
<title>E - GLOWASH LAUNDRY | STATUS PESANAN</title>
<?php head();
...
<head>
  ...
  <div class="login-logo">
    <a href=""><b>E - GLOWASH LAUNDRY </b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <!-- /.social-auth-links -->
	<br>
	  <p class="login-box-msg">Laundry Management System <br> Copyright © 2022 E - GLOWASH LAUNDRY</p>
