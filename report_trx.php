                  ...
                  <div class="row">
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-aqua">
                                           <div class="inner">
                                               <h3><?php echo $data1; ?><sup style="font-size: 20px">Transaksi</sup></h3>
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-yellow">
                                           <div class="inner">
                                               <h3><?php echo $data2; ?><sup style="font-size: 20px">Transaksi</sup></h3>
                    ...
                    <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-green">
                                           <div class="inner">
                                               <h3><?php echo $data3; ?><sup style="font-size: 20px">Transaksi</sup></h3>
                                               <p>Transaksi Berhasil Bulan Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
                                           </div>
                                   ...
                                   <div class="col-lg-3 col-xs-6">
                                       ...
                                       <div class="small-box bg-red">
                                           <div class="inner">
                                               <h3><?php echo $data4; ?><sup style="font-size: 20px">Transaksi</sup></h3>
                                               <p>Transaksi Berhasil Hari Ini</p>
                                           </div>
                                           <div class="icon">
                                               <i class="ion ion-stats-bars"></i>
                                           </div>
					...
					?>
                     <tbody>
                       ...
                       $namapelanggan=$rowa['nama'];
                         ...
                         <td>
                         <?php	if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') { ?>
                           <button type="button" class="btn btn-info btn-xs no-print btn-flat" onclick="window.location.href='order_detail?id=1&Transaksi=1&nota=<?php  echo $fill['nota']; ?>'">Detail</button>
                        <?php } else {}?>
