...
<?php }else{}
  if($chmenu1 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
               ...
               <ul class="treeview-menu">
                                <li>
                                    <a href="pengguna"><i class="fa fa-circle-o"></i>Data Pengguna</a>
                                </li>
<li>
                                    <a href="add_user"><i class="fa fa-circle-o"></i>Tambah Pengguna</a>
                                                  </li>
                            </ul>
                        </li>
...
if($chmenu5 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                        ...
                        <li class="treeview">
                            <a href="add_jual"> <i class="glyphicon glyphicon-shopping-cart"></i> <span>Pesanan Baru</span> <span class="pull-right-container"> </span> </a>
    ...
    <li class="treeview">
          <a href="#"> <i class="glyphicon glyphicon-inbox"></i> <span>Pesanan</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span> </a>
            <ul class="treeview-menu">
                <li>
                    <a href="order_data"><i class="fa fa-circle-o"></i>Data Pesanan</a>
                  </li>
                    <li>
                        <a href="order_batal"><i class="fa fa-circle-o"></i>Pembatalan Pesanan</a>
                      </li>
  ...
  if($chmenu8 >= 1 || $_SESSION['jabatan'] == 'admin'){ ?>
                          ...
                          <li class="treeview">
                              <a href="#"> <i class="glyphicon glyphicon-stats"></i> <span>Laporan</span> <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i> </span> </a>
  							 <ul class="treeview-menu">
                                  <li>
                                      <a href="report_trx"><i class="fa fa-circle-o"></i>Lap. Transaksi</a>
                                  </li>
                                  <li>
                                      <a href="report_revenue"><i class="fa fa-circle-o"></i>Lap. Pendapatan</a>
                                  </li>
