	<header class="main-header">
        <title>E - GLOWASH LAUNDRY</title>
                <!-- Logo -->
                <a href="<?php  echo $_SESSION['baseurl'];?>" class="logo">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b></b></span>
                    <!-- logo for regular state and mobile devices -->
                 <span class="logo-lg"><b>E - GLOWASH LAUNDRY</b></span>
                </a>
                ...
                <nav class="navbar navbar-static-top">
                  ...
                  <?php  echo $_SESSION['nama']; ?> - <?php  echo $_SESSION['jabatan']; ?></p>
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                              <a href="add_user?no=<?php  echo $_SESSION['nouser']; ?>" class="btn btn-default btn-flat">Profil</a>
                                        </div>
